...
const TEKST = {
  no: {
    ...
    match_type_label:'Hjemme eller away?', result_label:'Sluttresultat',
    ...
    seg_win:'Seier', seg_draw:'Uavgjort', seg_loss:'Tap',
    ...
    chart_win_pct:'Kumulativ seiersprosent', chart_win_pct_desc:'Viser hvordan seiersprosenten har utviklet seg gjennom sesongen', chart_goals_assists:'Mål \u0026 assist per kamp', chart_ga_desc:'Mål og assist i hver kamp, kronologisk', chart_goals_tourn:'Mål per turnering',
    ...
    share_cta:'Lag din egen profil på Athlytics Sport →',
  ...
  en: {
    ...
    match_type_label:'Home or away?', result_label:'Final Outcome',
    ...
    seg_win:'Victory', seg_draw:'Draw', seg_loss:'Loss',
    ...
    chart_win_pct:'Cumulative win %', chart_win_pct_desc:'Shows how win percentage has developed over the course of the season', chart_goals_assists:'Goals \u0026 assists per match', chart_ga_desc:'Goals and assists in each match, chronologically', chart_goals_tourn:'Goals by tournament',
    ...
    share_cta:'Create your own profile on Athlytics Sport →',
